Spree::Core::Engine.routes.draw do
  ...
  get 'admin/instagram/check_my_photos' => 'admin/instagram_photos#check_my_photos', as: 'admin_check_my_photos'
  ...
  get 'admin/profile_photos' => 'admin/instagram_photos#profile', as: 'admin_profile_photos'
end
